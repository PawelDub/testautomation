...
public class TestDataStatic {
    ...
    public final static String loginHeader = "Log in to your account.";
    public final static String continueButton = "Continue";

    public final static String mySite = "My Site";
    public final static String login = "automation012018@wp.pl";
    public final static String password = "Bimbajlo1@";
    public final static String notification = "Notification Settings";
}

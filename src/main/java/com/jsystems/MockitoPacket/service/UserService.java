...
//    }
    ...
    public List<UserMock> getAll(){
        return Arrays.asList(new UserMock(1,"Adam", "Kowalski"), new UserMock(2,"Iwona", "Jasielska"), new UserMock(3,"iron", "Pływak"));
    }

    public UserMock getOne(int user){
        return new UserMock(4,"Irek", "Dran");
    }
}
